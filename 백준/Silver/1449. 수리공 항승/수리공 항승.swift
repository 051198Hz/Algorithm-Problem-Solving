...
//현재 배열 중 가장 작은 배열에 팀원을 배치한다.

var file = FileIO()

var leakSpot: [Bool] = [Bool](repeating: false, count: 1001)
let spotNumber = file.readInt()
let tapeLength = file.readInt()
for _ in 0..<spotNumber{
    leakSpot[file.readInt()] = true
}
var leftTape = 0
var usedTapeCount = 0
for i in 1...1000{
